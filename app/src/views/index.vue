<template>
    <div class="hello">
        <header>
            ...
            <p @touchstart="changeWeekType">{{ singleWeekChanged }}</p>
            ...
            <svg fill="#FFFFFF" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" @touchstart="showMenu">
                <path d="M0 0h24v24H0z" fill="none"/>
